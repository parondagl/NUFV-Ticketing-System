...
<div class="col-lg-12">
	<div class="card card-outline ">
		<div class="card-header">
			...
			<a href="index.php?page=new_staff" class="btn btn-sm btn-success mr-2"><i class="fa fa-plus"></i> New Staff</a>
    ...
    <a href="./index.php?page=edit_staff&id=<?php echo $row['id'] ?>" class="btn btn-warning btn-xs update" role="button">
        Edit
    </a>
    <a href="javascript:void(0)" class="btn btn-danger btn-xs delete_staff" data-id="<?php echo $row['id'] ?>" role="button">
        Delete
    </a>
</td>
					</tr>	
